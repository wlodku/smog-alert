...
class StatsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create stat" do
    assert_difference('Stat.count') do
      post stats_url, params: { stat: { day: @stat.day, pm10: @stat.pm10, pm25: @stat.pm25, station_id: @stat.station_id } }
    end
  ...
  test "should update stat" do
    patch stat_url(@stat), params: { stat: { day: @stat.day, pm10: @stat.pm10, pm25: @stat.pm25, station_id: @stat.station_id } }
